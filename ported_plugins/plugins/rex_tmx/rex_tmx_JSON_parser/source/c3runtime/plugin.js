...
{
	C3.Plugins.Rex_tmx_JSON_parser = class Rex_tmx_JSON_parserPlugin extends C3.SDKPluginBase
	{
		constructor(opts)
		{
			super(opts);
			(function ()
			{
			    C3.Plugins.Rex_tmx_JSON_parser.TMXKlass = function(JSON_string)
			    {
			    ...
			    var TMXKlassProto = C3.Plugins.Rex_tmx_JSON_parser.TMXKlass.prototype;
