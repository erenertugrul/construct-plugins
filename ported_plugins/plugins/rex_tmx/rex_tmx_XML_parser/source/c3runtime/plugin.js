...
{
	C3.Plugins.Rex_tmx_XML_parser = class Rex_tmx_XML_parserPlugin extends C3.SDKPluginBase
	{
		constructor(opts)
		{
			super(opts);
			(function ()
			{
			    C3.Plugins.Rex_tmx_XML_parser.TMXKlass = function(tmx_string, isIE)
			    {
			    ...
			    var TMXKlassProto = C3.Plugins.Rex_tmx_XML_parser.TMXKlass.prototype;
