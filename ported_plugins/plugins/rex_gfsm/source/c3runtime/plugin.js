...
{
	C3.Plugins.Rex_FSM = class Rex_FSMPlugin extends C3.SDKPluginBase
	{
		constructor(opts)
		{
			super(opts);
			(function ()
			{
			    C3.Plugins.Rex_FSM.FSMKlass = function(plugin, previous_state, current_state)
			    {
			        this.Reset(plugin, previous_state, current_state);
			    };
			    var FSMKlassProto = C3.Plugins.Rex_FSM.FSMKlass.prototype;
			    ...
			    FSMKlassProto.Request = function(new_state)
			    {
					...
					this.plugin.run_trigger(C3.Plugins.Rex_FSM.Cnds.OnStateChanged);
			    ...
			    FSMKlassProto._run_transfer_action = function(pre_state, cur_state)
			    {
			        ...
			        var is_echo = this.plugin.run_trigger(C3.Plugins.Rex_FSM.Cnds.OnTransfer);
			    ...
			    {
			        this.plugin.check_state = pre_state;
				    var is_echo = this.plugin.run_trigger(C3.Plugins.Rex_FSM.Cnds.OnExit);
				    this.plugin.check_state = null;	    
				    ...
				    this.plugin.run_trigger(C3.Plugins.Rex_FSM.Cnds.OnDefaultExit);
			    };
			    
			    FSMKlassProto._run_enter_action = function(cur_state)
			    {
			        this.plugin.check_state = cur_state;
				    var is_echo = this.plugin.run_trigger(C3.Plugins.Rex_FSM.Cnds.OnEnter);
				    this.plugin.check_state = null;
				    ...
				    this.plugin.run_trigger(C3.Plugins.Rex_FSM.Cnds.OnDefaultEnter); 
			    };  
